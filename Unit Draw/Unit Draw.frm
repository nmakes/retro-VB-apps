...
Begin VB.Form Form1 
   ...
   EndProperty
   Icon            =   "Unit Draw.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   2880
   ScaleWidth      =   2880
   Begin VB.CheckBox Check144 
      Height          =   255
      Index           =   6
      Left            =   2640
      Style           =   1  'Graphical
